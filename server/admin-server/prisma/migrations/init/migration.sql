...
-- CreateIndex
CREATE INDEX "idx_sys_dict_data_dictType" ON "sys_dict_data"("dictType");
...
-- CreateIndex
CREATE INDEX "idx_sys_user_deptId" ON "sys_user"("deptId");
