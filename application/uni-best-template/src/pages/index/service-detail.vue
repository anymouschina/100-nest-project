...
<template>
  <view class="service-detail">
    <image
      ...
      src="https://linkxspace.cn/nest-admin//upload/2025-06-06/1749223887358-161576767-qpkpCEhcnaKo6d90c01dd60f857ce07e211443addf02.jpg"
      mode="widthFix"
      class="banner-img"
    ></image>
    ...
    <view class="problem-section">
      ...
      <view class="problem-grid">
        <view
          class="problem-item"
          v-for="(problem, index) in serviceData.problemScenes"
          :key="index"
        >
...
const serviceData = reactive<IServiceDetail>({
  ...
  subtitle: '官方涂料独家供应商',
  description:
    '华建修缮一站式防水修缮服务，专业师傅免费上门，快速响应，品质保障。我们提供屋顶、厨房、卫生间、阳台等多场景防水解决方案。',
  bannerImages: [
    { url: '', color: '#3d9c40' },
    { url: '', color: '#4CAF50' },
    { url: '', color: '#81C784' },
